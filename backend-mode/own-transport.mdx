...
description: "Backend Mode Integration where your backend relays encoded audio and motion messages directly to clients."
---

## What is Backend Mode with your own transport?

This is the [Backend Mode Integration](/backend-mode/overview) shape where **your application** owns the network connection between AvatarKit's server-side SDK and the client. Your server sends encoded messages to your client, and the client SDK receives and **decodes them internally** for synchronized playback and rendering.
