...
<Note>
**Backend Mode does not require LiveKit or Agora.** The required integration point is the Spatius Server SDK on your backend. RTC providers are downstream transport options after your backend receives messages from Motion Server.
</Note>
