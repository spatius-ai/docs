...
- [Backend Mode demo](https://github.com/spatius-ai/spatius-avatar-demo/tree/main/backend-mode) — the backend half (ASR/LLM/TTS + Spatius Server SDK). It ships with its own WebSocket transport; swap in LiveKit egress to match this pattern.
