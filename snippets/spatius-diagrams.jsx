  ...
  return (
    <div className="spatius-diagram not-prose" aria-label="LiveKit Agents Integration architecture">
      <svg viewBox="-83 0 1535 800" role="img">
        ...
        <text x="440" y="72" textAnchor="middle" fill="var(--spatius-diagram-red)" fontSize="30" fontWeight="600">Managed by you</text>
        ...
        <rect x="500" y="590" width="370" height="78" rx="12" fill="var(--spatius-diagram-node)" stroke="var(--spatius-diagram-stroke)" strokeWidth="3" />
        <text x="685" y="624" textAnchor="middle" fill="var(--spatius-diagram-ink)" fontSize="30" fontWeight="500">Web RTC Adapter</text>
        ...
        <rect x="535" y="705" width="300" height="70" rx="12" fill="var(--spatius-diagram-node)" stroke="var(--spatius-diagram-stroke)" strokeWidth="3" />
...
export const AgoraConvoAiDiagram = () => {
  return (
    <div className="spatius-diagram spatius-agora-diagram not-prose" aria-label="Agora Convo AI and TEN Framework Integration architecture">
      <svg viewBox="-83 0 1535 800" role="img">
        <defs>
        ...
        <text x="440" y="72" textAnchor="middle" fill="var(--spatius-diagram-agora)" fontSize="30" fontWeight="600">Agent Runtime</text>
        <text x="1000" y="72" textAnchor="middle" fill="var(--spatius-diagram-brand)" fontSize="30" fontWeight="600">Spatius Managed</text>
        ...
        <text x="440" y="148" textAnchor="middle" fill="var(--spatius-diagram-agora)" fontSize="21" fontWeight="600">Agora Convo AI / TEN</text>
        <rect x="285" y="168" width="310" height="112" rx="12" fill="var(--spatius-diagram-node)" stroke="var(--spatius-diagram-stroke)" strokeWidth="3" />
        <text x="440" y="204" textAnchor="middle" fill="var(--spatius-diagram-ink)" fontSize="29" fontWeight="500">
          <tspan x="440">Agent pipeline</tspan>
        ...
        <text x="440" y="360" textAnchor="middle" fill="var(--spatius-diagram-muted)" fontSize="19" fontWeight="500">provider / extension</text>
        ...
        <rect x="470" y="570" width="430" height="215" rx="18" fill="var(--spatius-diagram-owned)" stroke="var(--spatius-diagram-stroke)" strokeWidth="3" opacity="0.72" />
        <rect x="500" y="590" width="370" height="78" rx="12" fill="var(--spatius-diagram-node)" stroke="var(--spatius-diagram-stroke)" strokeWidth="3" />
        <text x="685" y="624" textAnchor="middle" fill="var(--spatius-diagram-ink)" fontSize="30" fontWeight="500">AvatarKit RTC client</text>
        <text x="685" y="652" textAnchor="middle" fill="var(--spatius-diagram-muted)" fontSize="20" fontWeight="500">packaged Agora provider</text>
