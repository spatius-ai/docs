...
The SDK defaults to the `us-west` region. See [Regions](/api-reference/regions) for the current region list.
...
- `region: str` - Spatius region. Defaults to `us-west`; see [Regions](/api-reference/regions).
