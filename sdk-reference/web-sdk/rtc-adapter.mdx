...
description: "Use @spatius/avatarkit-rtc as the Web transport adapter for LiveKit and future RTC providers."
---
...
| Provider | Status |
| --- | --- |
| `LiveKitProvider` | Documented here. Demoed in [`platform-integrations/livekit-room-demo`](https://github.com/spatius-ai/spatius-avatarkit-demo/tree/main/platform-integrations/livekit-room-demo). |
