...
<Accordion title="init(region:audioFormat:drivingServiceMode:logLevel:)">
...
**Parameters:**
- `region`: The region to connect to (`"us-west"` or `"ap-northeast"`)
...
| Instance Property | Type | Description |
|----------|------|-------------|
| `region` | `String` | The region the SDK connects to (`"us-west"` or `"ap-northeast"`). |
