...
Use `DrivingServiceMode.sdk` for [Direct Mode](/direct-mode/overview). Use `DrivingServiceMode.host` when your Flutter app receives encoded audio payloads and motion data payloads from a [Backend Mode](/backend-mode/overview).
