...
Download the optional 16:9 background from Spatius Studio and add it as a drawable resource. In Compose, place the background `Image` and transparent `AvatarView` in the same `Box`.
