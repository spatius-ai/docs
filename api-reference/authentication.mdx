...
| Video access is not configured, creation is paused, or the Avatar is not allowed | `403` | `forbidden` | See [Video access](/api-reference/video-generation#access-and-safe-retries). |
