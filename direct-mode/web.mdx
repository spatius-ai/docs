...
<CardGroup cols={2}>
  ...
  <Card title="Multi-framework reference" icon="github" href="https://github.com/spatius-ai/spatius-avatarkit-demo/tree/main/direct-mode/clients/web/reference">
...
<Accordion title="TypeScript: declare `region` (required for @spatius/avatarkit@1.0.0)">
The runtime accepts `region`, but the published types in `@spatius/avatarkit@1.0.0` do not yet expose it. Add a single declaration-merging file to your project so TypeScript stops complaining:
