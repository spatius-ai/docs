...
Send PCM16 mono avatar speech audio to AvatarKit. Motion Server returns motion data, and AvatarKit renders the avatar locally through the native platform renderer. For audio source and timing guidance, see [Audio](/concepts/audio).
</Step>
</Steps>
