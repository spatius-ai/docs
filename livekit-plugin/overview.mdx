...
If you already use [LiveKit Agents](https://docs.livekit.io/agents/), add `livekit-plugins-spatius` to your agent worker. The plugin attaches to your `AgentSession` and sends TTS audio to Spatius; Motion Server publishes the resulting audio and motion data to the same LiveKit room.
