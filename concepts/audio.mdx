...
- **Who sends it**: In [Basic Mode](/basic-mode/overview), the client sends it. In [LiveKit Plugin](/livekit-plugin/overview), it is handled automatically. In [Custom Mode](/custom-mode/overview), the developer maintains the flow.
