...
| **Agora Convo AI Integration** | The Convo AI avatar provider or TEN extension starts the Spatius server session, and Motion Server pushes data into the Agora channel. | The client joins the channel, and AvatarKit automatically renders from the channel. |
