...
| **[Backend Mode](/backend-mode/overview)** | A custom integration path. Your backend uses the Server SDK and chooses a downstream transport (your own WebSocket, LiveKit Room, or future Agora Room). |
