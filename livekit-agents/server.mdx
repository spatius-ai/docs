...
For a working end-to-end reference, see [AvatarKit Voice Agent Demo](https://github.com/spatius-ai/spatius-avatarkit-demo/tree/main/platform-integrations/livekit-agents-demo/livekit-agents-reference-demo).
