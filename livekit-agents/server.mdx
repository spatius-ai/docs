...
Full API and options: **[the plugin reference](https://docs.livekit.io/reference/python/livekit/plugins/spatius/index.html#livekit.plugins.spatius.AvatarSession)**
