...
| **You build** | 🎙️ LiveKit Agents worker wiring, 🔌 Spatius plugin configuration, and 🌐 Web RTC client. |
...
Spatius plugin is part of LiveKit Agents framework since 1.6.7, see [the LiveKit documentation](https://docs.livekit.io/agents/models/avatar/plugins/spatius/) for the setup,
and [LiveKit Agents Integration Server](/livekit-agents/server) for the full reference.
