...
This quickstart targets the [Direct Mode](/direct-mode/overview) path in a Flutter app. The sample runs on iOS and Android and uses the `spatius_avatarkit` Flutter package.
