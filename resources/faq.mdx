...
Public docs and examples default to `us-west`. Demo behavior can also depend on the realtime provider used by that demo, such as LiveKit Cloud edge routing.

If your product needs a specific deployment region, confirm the target region with the Spatius team before production launch.
