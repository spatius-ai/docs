...
See [Audio](/concepts/audio) for configuration details.
...
See the [Web SDK guide](/direct-mode/web) for setup instructions.
...
<Accordion title="LiveKit RTC client: version compatibility">
